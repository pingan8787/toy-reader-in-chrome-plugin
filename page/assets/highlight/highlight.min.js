...
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `plaintext` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("typescript",e)})();/*! `markdown` grammar compiled for Highlight.js 11.3.1 */
